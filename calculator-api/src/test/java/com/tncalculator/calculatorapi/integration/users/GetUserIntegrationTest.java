...
public class GetUserIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    public void testGetUserByIdWithInvalidUUID() throws URISyntaxException {
    ...
    @Test
    public void testGetUserByIdNotFound() throws URISyntaxException {
    ...
    public void testGetUserById() throws URISyntaxException, JsonProcessingException {
        ...
        assertAll(
                ...
                () -> assertEquals(user.getAuthorities().stream().map(Role::getAuthority).collect(Collectors.toSet()), response.getRoles())
        );
    }
}
