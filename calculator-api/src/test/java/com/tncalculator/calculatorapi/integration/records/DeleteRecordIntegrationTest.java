...
public class DeleteRecordIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    public void testDeleteRecordByIdWithInvalidUUID() throws URISyntaxException {
    ...
    @Test
    public void testDeleteRecordByIdCurrentUserNotFound() throws URISyntaxException {
        URI uri = new URI(String.format(url, UUID.randomUUID()));

        HttpEntity<?> request = new HttpEntity<>(headers);
        ResponseEntity<ApiError> result = this.restTemplate.exchange(uri, HttpMethod.DELETE, request, ApiError.class);
    ...
    @Test
    public void testDeleteRecordByIdNotFound() throws URISyntaxException {
    ...
    @Test
    public void testDeleteRecord() throws URISyntaxException {
        ...
        assertFalse(recordRepository.existsByIdNotDeleted(record.getId()));
    }
